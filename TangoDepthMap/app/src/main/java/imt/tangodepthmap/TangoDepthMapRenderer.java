...
public class TangoDepthMapRenderer implements GLSurfaceView.Renderer {
    ...
    private TangoDepthMapActivity mTangoDepthMapActivity;

    public TangoDepthMapRenderer(TangoDepthMapActivity tangoDepthMapActivity) {
        mTangoDepthMapActivity = tangoDepthMapActivity;
    }
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        mTangoDepthMapActivity.surfaceCreated();
    }
}
