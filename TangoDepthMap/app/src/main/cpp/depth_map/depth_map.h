...
#ifndef TANGODEPTHMAP_DEPTH_MAP_H
#define TANGODEPTHMAP_DEPTH_MAP_H
...
// DepthMap handles the application lifecycle and resources.
    class DepthMap {
    public:
        enum TextureMethod {
            kYuv,
...
#endif  // TANGODEPTHMAP_DEPTH_MAP_H
