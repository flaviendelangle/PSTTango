...
public class OldActivity extends AppCompatActivity implements CameraBridgeViewBase.CvCameraViewListener2 {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ActivityCompat.requestPermissions(OldActivity.this,
    ...
    protected void onResume() {
        ...
        */
        mTango = new Tango(OldActivity.this, new Runnable() {
            @Override
            public void run() {
                synchronized (OldActivity.this) {
                    try {
    ...
    private void showsToastAndFinishOnUiThread(final int resId) {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(OldActivity.this,
        ...
        switch (requestCode) {
            case 1: {
                ...
                if (grantResults.length > 0
                    ...
                    Toast.makeText(OldActivity.this, "Permission denied to read your External storage", Toast.LENGTH_SHORT).show();
                }
                return;
            }
    ...
    public Mat onCameraFrame(CameraBridgeViewBase.CvCameraViewFrame inputFrame) {
        Log.d("gDebug", "OPEN CV IS CALLED");
